    ...
    return res.body!.result!
        .map(
          (e) => Device(
            ...
            deviceStatusBatteryLevelUnavailable: e.deviceStatusBatteryLevelUnavailable.orDefault(),
            deviceStatusExternalPowerSource: e.deviceStatusExternalPowerSource.orDefault(),
